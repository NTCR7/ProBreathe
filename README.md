...
## Inhaltsverzeichnis
- <a href="test">**1. Einleitung**</a> 
  - <a href="test">**Das ist ProBreathe**</a> 
  - <a href="test">**Der Beweggrund**</a> 
...
- <a href="test">**3. Verwendete libraries**</a> 
  ...
  - <a href="test">**OpenCV**</a> 
  - <a href="test">**Metaplotlib**</a> 
  - <a href="test">**Seaborn**</a> 
  - <a href="test">**NumPy**</a>
...
- <a href="test">**4. Funktionsweise des models & CNN**</a> --> Gegenlesen, Bilder prüfen, Output einfügen
  - <a href="test">**Datenvorbereitung**</a>
     ...
     - <a href="test">**Data Augmentation**</a>
  - <a href="test">**Modellarchitektur**</a>
     - <a href="test">**Verhalten des Modells im Training**</a>
  - <a href="test">**Training des Modells**</a>
  - <a href="test">**Leistung & Genauigkeit**</a>
  - <a href="test">**Anwendung**</a>
     - <a href="test">**Klassifizierung neuer Bilder**</a>
     - <a href="test">**Gradio-Schnittstelle**</a>
- <a href="test">**5. -Projektzusatz- Einfluss verschiedener Parameter**</a>
  - <a href="test">**Hyperparameteroptimierung durch GridSearchCV**</a>
  - <a href="test">**Empirischer Versuch Änderung Data-Augmentation**</a>
- <a href="test">**6. Das Ergebnis & Anwendung**</a>
- <a href="test">**7. Reflexion**</a> 
- <a href="test">**8. Quellenverzeichnis**</a> 
...
<img src="images/0.png" width="1200" alt="Code Preview">
...
<p align="center">
  <a href="download" ><img src="images/download.png" width="150" alt="Download"></a>
</p>
...
4. Probleme mit dem Interface? Führen Sie den Code selbst nochmal aus (Ergebnis kann stark abweichen) oder schauen Sie sich das  <a href="test">YouTube-Video</a> an.
   Um den Code selbst ausführen zu können, müssen Sie sich ein <a href="https://www.kaggle.com/account/login?phase=startRegisterTab&returnUrl=%2F">Konto erstellen</a> und dann unterm dem <a href="test">Link zum Code</a> auf `Copy & Edit` clicken. Informationen zum Umgang mit kaggle finden Sie <a href="test">hier</a>.
